...
namespace FellSky.Editor
{
    ...
    public class D3D11Host : Image, IGraphicsDeviceService, IDisposable
    {
        ...
        private void OnLoaded(object sender, RoutedEventArgs eventArgs)
        {
            ...
            DeviceCreated?.Invoke(this, null);
        ...
        private void OnUnloaded(object sender, RoutedEventArgs eventArgs)
        {
            ...
            StopRendering();
            DeviceDisposing?.Invoke(this, null);
            Unitialize();
        ...
        private void CreateBackBuffer()
        {
            ...
            _renderTarget = new RenderTarget2D(_graphicsDevice, width, height, false, SurfaceFormat.Bgr32, DepthFormat.None, 0, RenderTargetUsage.DiscardContents, true);
