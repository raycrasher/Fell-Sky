...
{
    public class StateManagerService<TStateBase, TEventBase>
    {
        ...
        public StateManagerService<TStateBase, TEventBase> AddTransition<TCurrent, TNext>(Func<TStateBase, TStateBase, bool> func)
        ...
        public StateManagerService<TStateBase, TEventBase> AddEventHandler<TState,TEvent>(Action<TStateBase, TEventBase> func)
